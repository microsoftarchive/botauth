...
const authlib = require("./lib/library");
 ...
 * @return {BotAuth} this
 */
botauth.prototype.provider = function (name, strategy, options) {
    if(!_server) {
        throw Error("must call configure before calling provider");
    }

    passport.use(name, strategy, function(accessToken, refreshToken, profile, done) {
